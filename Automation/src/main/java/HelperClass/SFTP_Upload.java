...
private static Logger log = LogManager.getLogger(SFTP_Upload.class.getName());
              ...
              public void SFTPUpload(String hostname, int portno, String Username, String Password, String LocalFilepath, String RemoteFilepath, String fileName) {
                             try {
                                           JSch jsch = new JSch();
                                  ...
                                  System.out.println("SFTP Connection established");
                                           ...
                                           //sftpChannel.get(fileName, localFile + "\\" + fileName);
                                           Thread.sleep(1000);
                                           channel.disconnect();
                                 session.disconnect();
                                 log.info("File uploaded in SFTP successfully");
                             } catch (Exception e) {
                                           System.out.println("Error: " + e.getMessage());
                                           log.info("Error in uploading file to SFTP: " + e.getMessage());
                             }
              }
